...
If you want to use this app with the ToneForge / JamesDSP magisk module on a rooted device, follow these instructions:

**Important: I don't actively test root builds. They may be more unstable than the regular rootless version.**

1. Install the ToneForge / JamesDSP magisk module if not already done.
2. Uninstall the original ToneForge / JamesDSP app.
...
8. Done. You should now be able to use ToneForge normally.
...
**This app behaves differently than the original JamesDSP app:**
...
## Restoring original JamesDSP
Uninstall this app, download the original JamesDSP APK: https://github.com/Magisk-Modules-Repo/ainur_jamesdsp/raw/master/JamesDSPManager.apk, and install it. A reboot may be necessary.
